...
var Manifest = require("./manifest")("./swarm.md", __filename)
...
var Swarm = module.exports = function Swarm(api) {
  ...
  source.connections = valid.sync(function(){
   return source._connections; 
  });
  ...
  source.addProtocol = function (protocol) {
    ...
    _api = merge(_api, unflatten(pick(flatten(prefix(protocol.path, clone(protocol)), { safe: true }), paths), { safe: true }))
  }
